...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rig_name', models.CharField(blank=True, max_length=255, null=True)),
                ('well', models.CharField(blank=True, max_length=255, null=True)),
                ('shift', models.CharField(blank=True, choices=[('Day', 'First Shift'), ('Night', 'Second Shift')], default='Day', max_length=50, null=True)),
                ('slug', models.CharField(default=0, max_length=255, unique=True)),
