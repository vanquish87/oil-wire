...
def viewEquipmentLog(request, rig_id):
    ...
    send_mail(
    'Testing Mail',
    'Hello Sir, An Equipment log has been submitted which can be accessed through the link : http://10.205.18.94:9000/mechanical/view-equipment-log/'+str(rig_id)+'/',

    'gaurav@ongc.co.in',
    ['jaingaurav126@gmail.com'],
    fail_silently=False,)
...
def viewElecticLog(request,rig_id):
    ...
    send_mail(
    'Testing Mail',
    'Hello Sir, An Equipment log has been submitted which can be accessed through the link : http://10.205.18.94:9000/mechanical/view-electric-log/'+str(rig_id)+'/',
...
def viewDrillLog(request, rig_id):
    ...
    send_mail(
    'Testing Mail',
    'Hello Sir, An Equipment log has been submitted which can be accessed through the link : http://10.205.18.94:9000/mechanical/view-drill-log/'+str(rig_id)+'/',
    'gaurav@ongc.co.in',
    ['jaingaurav126@gmail.com'],
    fail_silently=False,)
